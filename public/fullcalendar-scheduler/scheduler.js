...
TimelineHelperRenderer = (function(superClass) {
  ...
  TimelineHelperRenderer.prototype.renderSegs = function(segs, sourceSeg) {
    ...
    helperContainerEl = $('<div class="event-container fc-helper-container"/>').appendTo(this.component.innerEl);
...
TimelineView = (function(superClass) {
  ...
  TimelineView.prototype.renderSkeleton = function() {
    ...
    this.segContainerEl = $('<div class="event-container"/>').appendTo(this.timeBodyScroller.canvas.contentEl);
...
EventRow = (function(superClass) {
  ...
  EventRow.prototype.renderEventSkeleton = function(tr) {
    var theme;
    theme = this.view.calendar.theme;
    tr.html('<td class="' + theme.getClass('widgetContent') + '"> <div> <div class="event-container" /> </div> </td>');
    this.segContainerEl = tr.find('.event-container');
