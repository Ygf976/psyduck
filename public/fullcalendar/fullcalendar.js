...
exports.default = {
    ...
    // A value of '' will query attributes like data-event. A value of 'fc' will query attributes like data-event.
    dataAttrPrefix: '',
    views: {},
    locales: {}
};
...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    function InteractiveDateComponent(_view, _options) {
        ...
        _this.segSelector = '.event-container > *'; // what constitutes an event element?
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        var content = $('<div class="fc-header ' + theme.getClass('popoverHeader') + '">' +
            ...
            '</div>');
        var segContainer = content.find('.event-container');
        var i;
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderContentSkeleton = function () {
        ...
        for (i = 0; i < this.colCnt; i++) {
            cellHtml +=
                '<td>' +
                    ...
                    '<div class="event-container fc-helper-container"></div>' +
                    '<div class="event-container"></div>' +
        ...
        this.fgContainerEls = skeletonEl.find('.event-container:not(.fc-helper-container)');
        ...
        for (i = 0; i < levelCnt; i++) {
            ...
            if (levelSegs) {
                for (j = 0; j < levelSegs.length; j++) {
                    ...
                    td = $('<td class="event-container"/>').append(seg.el);
